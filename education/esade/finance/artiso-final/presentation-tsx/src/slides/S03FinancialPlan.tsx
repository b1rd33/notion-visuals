    ...
    <section className={`slide slide--white${active ? ' active' : ''}`} id="s3">
      ...
      <table style={{ marginTop: '12px' }}>
        ...
        <tbody>
          ...
          <tr className="highlight"><td className="bold">EBITDA</td><td className="right">(€120K)</td><td className="right">(€267K)</td><td className="right">(€565K)</td><td className="right">(€1.3M)</td><td className="right">(€351K)</td><td className="right">+€3.1M</td><td className="right">+€8.3M</td></tr>
