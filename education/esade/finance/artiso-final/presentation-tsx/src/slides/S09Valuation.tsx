      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', flex: 1 }}>
        ...
        <div className="split-right anim-fade-in" style={{ padding: '50px 80px 50px 40px', display: 'flex', flexDirection: 'column', background: 'linear-gradient(135deg, #e8e4f0 0%, #c7cce8 50%, #a5b0d8 100%)', animationDelay: '1.2s' }}>
          <div style={{ textAlign: 'center' as const, marginBottom: '16px' }}>
            ...
            <div style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '4px' }}>Far exceeds 40% hurdle · 11.9x return</div>
          </div>
          ...
          <table style={{ fontSize: '14px' }}>
            ...
            <tbody>
              <tr><td>FY2026 Revenue × 40x</td><td className="right">€25.8M</td></tr>
              <tr><td>FY2026 ARR × 20x</td><td className="right">€26.5M</td></tr>
              <tr><td>FY2027 Forward Rev × 5x</td><td className="right">€26.8M</td></tr>
              <tr><td>VC Method (backward)</td><td className="right">€90.3M</td></tr>
          ...
          <div style={{ background: 'rgba(255,255,255,0.5)', borderRadius: '8px', padding: '10px 14px', marginTop: '12px', textAlign: 'center' as const }}>
            <p style={{ fontSize: '13px', color: 'var(--text)', lineHeight: 1.5 }}>Range: €25.8M – €90.3M · <strong>€27M is at the conservative end</strong><br /><span style={{ color: 'var(--text-muted)' }}>Acceptable: €22-25M if it secures a strong lead</span></p>
          </div>
          ...
          <div style={{ marginTop: 'auto', background: 'rgba(255,255,255,0.4)', borderRadius: '8px', padding: '8px 14px', textAlign: 'center' as const }}>
            <div style={{ fontSize: '11px', color: 'var(--text-muted)' }}>At 10x ARR exit (€358M): each founder's 26.7% = <strong style={{ color: 'var(--purple-deep)' }}>€96M</strong></div>
          </div>
        </div>
      </div>

      <SlideFooter framework="Session 04 — 5-Step VC Method + Valuation Triangulation" slideNum="9 / 12" />
    </section>
  )
}
