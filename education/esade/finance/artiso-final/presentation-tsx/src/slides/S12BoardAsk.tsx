  ...
  return (
    <section className={`slide slide--gradient-deep${active ? ' active' : ''}`} id="s12">
      ...
      <div style={{ marginTop: 'auto', textAlign: 'center' as const, paddingBottom: '8px' }}>
        <p style={{ fontSize: '20px', color: 'rgba(255,255,255,0.85)', fontStyle: 'italic', maxWidth: '700px', margin: '0 auto', lineHeight: 1.5 }}>"The discipline is not just raising this round. It is ensuring the company reaches the next round with evidence, optionality, and negotiating leverage."</p>
