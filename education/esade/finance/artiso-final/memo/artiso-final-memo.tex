...
The blended structure reduces total dilution from 10\% (pure equity) to 6--8\%, preserving founder ownership at 26.7\% each post-round. Up to 40\% of the round comes from non-dilutive sources. This is the fastest path to Series~A from a position of strength, backed by pilot revenue (\euro{}60\,K+ from Deichmann, TATA, NF\&TA), 200+ brand waitlist, 82\% gross margins, and 7 paying logos.
